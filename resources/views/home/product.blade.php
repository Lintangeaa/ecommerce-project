    ...
    <div class="container">
        <div class="heading_container heading_center">
            ...
            <p class="card-text font-weight-bold" style="font-family: Arial, Helvetica, sans-serif;">
                ...
                memastikan pertumbuhan yang optimal dan hasil panen yang memuaskan. Dukung keberhasilan bisnis Anda
                dalam
            ...
            @foreach ($product as $products)
                <div class="col-sm-6 col-md-4 col-lg-3">
                    <div class="text-center rounded box">
                        ...
                        <div class="mx-auto rounded img-box custom-bg">
                        ...
                        @if ($products->quantity <= 0)
                            <div style="color: red;">Stok Habis</div>
                        @else
                            <div>Stok: {{ $products->quantity }}</div>
                        @endif


                        <div style="padding: 5px">
                            <a class="btn btn-danger" style="color:white"
                                href="{{ url('product_details', $products->id) }}">Detail</a>

                            @if ($products->quantity > 0)
                                <a class="btn btn-primary" style="color:white"
                                    href="{{ url('add_cart', $products->id) }}">Tambah</a>
                            @endif
